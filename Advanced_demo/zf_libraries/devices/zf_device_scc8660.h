...
#define SCC8660_COF_IIC_DELAY   (1000)                                           // 凌瞳 IIC 延时
#define SCC8660_COF_IIC_SCL     (CAMERA_SCL)                                           // 凌瞳 IIC-SCL 引脚
#define SCC8660_COF_IIC_SDA     (CAMERA_SDA)                                           // 凌瞳 IIC-SDA 引脚
...
#define SCC8660_BRIGHT_DEF      (2000)                                           // 亮度设置     手动曝光默认：300   手动曝光时：参数范围0-65535   自动曝光推荐值：100 自动曝光时参数设置范围0-255
...
extern uint16       scc8660_buff[SCC8660_W*SCC8660_H];
