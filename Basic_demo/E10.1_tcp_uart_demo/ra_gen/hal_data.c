...
const timer_cfg_t g_timer1_cfg =
{
    ...
    /* Actual period: 0.019989013671875 seconds. Actual duty: 49.9236641221374%. */ .period_counts = (uint32_t) 0x28f, .duty_cycle_counts = 0x147, .source_div = (timer_source_div_t)0,
    .channel             = 1,
