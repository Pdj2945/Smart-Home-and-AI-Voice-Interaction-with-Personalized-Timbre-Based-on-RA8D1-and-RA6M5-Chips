...
adc_instance_ctrl_t g_adc7_ctrl;
const adc_extended_cfg_t g_adc7_cfg_extend =
...
#if ((0) | (0))
const adc_window_cfg_t g_adc7_window_cfg =
{
    .compare_mask        =  0,
    .compare_mode_mask   =  0,
...
#endif
const adc_channel_cfg_t g_adc7_channel_cfg =
{ .scan_mask = ADC_MASK_CHANNEL_7 | 0, .scan_mask_group_b = 0, .priority_group_a = ADC_GROUP_A_PRIORITY_OFF, .add_mask =
          0,
  .sample_hold_mask = 0, .sample_hold_states = 24,
#if ((0) | (0))
    .p_window_cfg        = (adc_window_cfg_t *) &g_adc7_window_cfg,
#else
  .p_window_cfg = NULL,
#endif
        };
/* Instance structure to use this module. */
const adc_instance_t g_adc7 =
{ .p_ctrl = &g_adc7_ctrl, .p_cfg = &g_adc7_cfg, .p_channel_cfg = &g_adc7_channel_cfg, .p_api = &g_adc_on_adc };
adc_instance_ctrl_t g_adc4_ctrl;
const adc_extended_cfg_t g_adc4_cfg_extend =
{ .add_average_count = ADC_ADD_OFF,
  .clearing = ADC_CLEAR_AFTER_READ_ON,
  .trigger = ADC_START_SOURCE_DISABLED,
  .trigger_group_b = ADC_START_SOURCE_DISABLED,
...
{ .unit = 0, .mode = ADC_MODE_SINGLE_SCAN, .resolution = ADC_RESOLUTION_12_BIT, .alignment =
  ...
  .scan_end_b_ipl = (BSP_IRQ_DISABLED), };
#if ((0) | (0))
const adc_window_cfg_t g_adc4_window_cfg =
{
    .compare_mask        =  0,
    .compare_mode_mask   =  0,
    .compare_cfg         = (adc_compare_cfg_t) ((0) | (0) | (0) | (ADC_COMPARE_CFG_EVENT_OUTPUT_OR)),
...
#endif
const adc_channel_cfg_t g_adc4_channel_cfg =
{ .scan_mask = ADC_MASK_CHANNEL_4 | 0, .scan_mask_group_b = 0, .priority_group_a = ADC_GROUP_A_PRIORITY_OFF, .add_mask =
          0,
  .sample_hold_mask = 0, .sample_hold_states = 24,
#if ((0) | (0))
    .p_window_cfg        = (adc_window_cfg_t *) &g_adc4_window_cfg,
#else
  .p_window_cfg = NULL,
#endif
        };
/* Instance structure to use this module. */
const adc_instance_t g_adc4 =
{ .p_ctrl = &g_adc4_ctrl, .p_cfg = &g_adc4_cfg, .p_channel_cfg = &g_adc4_channel_cfg, .p_api = &g_adc_on_adc };
